...
const AddCategoryFunction =()=>{
  navigate("/dashboards/dashboard1/AddCategory")
}
const AddOfferFunction =()=>{
  navigate("/dashboards/dashboard1/AddOffer")
}
...
const LogoutFunction =(e)=>{
  ...
  console.log("iduser after logout",localStorage.getItem('idUSER'))
  localStorage.removeItem('iduser')
 navigate('/')
}
  return (
    <AppBar sx={props.sx} elevation={0} className={props.customClass}>
      <Toolbar>
        ...
        >
          ...
          <Divider />
          <MenuItem onClick={AddCategoryFunction}>
            <Avatar
              sx={{
                width: "35px",
                height: "35px",
          ...
          <MenuItem onClick={AddOfferFunction}>
            <Avatar
              sx={{
                width: "35px",
                height: "35px",
