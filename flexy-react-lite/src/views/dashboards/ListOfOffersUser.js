...
const cs= new CategoryService()
  ...
  const ViewDetailOffer = (id) => {
    navigate("/dashboards/DashboardUser/ViewDetailOffer/" + id, { state: { id: id } })
  }
  const UpdateOffer = (id) => {
    navigate("/dashboards/DashboardUser/UpdateOffer/" + id, { state: { id: id } })
  }
...
export default ListOfOffersUser;